...
public class View extends GridPane {
	...
	public void setValues() {
		Model blah = new Model(Integer.parseInt(this.dependentTF.getText()));

		this.independentTF.setText(blah.getNumCredits());
	}

	// TODO Resets the various textfields
	// back to empty spots
	public void clearValues() {
		this.independentTF.clear();
		this.dependentTF.clear();
	}
